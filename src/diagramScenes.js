...
(() => {
  ...
  const scenes = {
    ...
    islands: {
      ...
      players: [P('blue', 62, 66, '1'), P('blue', 90, 68, '2'), P('blue', 250, 64, '3'), P('blue', 280, 69, '4'), P('blue', 61, 171, '5'), P('blue', 89, 174, '6'), P('blue', 251, 171, '7'), P('blue', 280, 173, '8')],
      balls: [B(70, 74), B(98, 76), B(258, 72), B(288, 77), B(69, 179), B(97, 182), B(259, 179), B(288, 181)],
